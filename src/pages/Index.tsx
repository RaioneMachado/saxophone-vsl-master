    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 pt-16 pb-20">
        <div className="container mx-auto px-4">
          ...
          {/* Main Video Section - AGORA COM YOUTUBE */}
          <section className="mb-16 flex justify-center">
            <div className="w-full max-w-4xl text-center">
              <h3 className="text-2xl md:text-3xl font-bold text-primary glow-text-blue mb-4 font-display">
                Veja como funciona!
              </h3>
              {/* Player YouTube - Substituído o Panda Video */}
              <div className="aspect-video rounded-xl overflow-hidden shadow-2xl border-4 border-primary/30">
                <iframe
                  src="https://www.youtube.com/embed/qMOaQcg3RRU?rel=0&modestbranding=1&controls=1&showinfo=0"
                  className="w-full h-full"
                  title="Vídeo Partituras Premium - Demonstração"
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Assista em tela cheia para melhor experiência. Use os controles para pausar, ajustar volume e repetir trechos.
              </p>
            </div>
          </section>
